...
Lorsqu'elle est définie, la matrice hessienne est symétrique: en effet, le théorème de Schwarz assure que pour une fonction $f$ deux fois différentiable en $a \in \RR^n$, on a
\begin{equation*}
