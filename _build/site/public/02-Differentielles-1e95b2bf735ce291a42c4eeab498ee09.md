...
:::{margin}
On surcharge ici l'opération $f'(a) \cdot h$: cette notation s'utilise que
- $f'(a)$ soit un réel et $h$ un réel
- $f'(a)$ soit un vecteur et $h$ un vecteur
- $f'(a)$ soit une matrice et $h$ un vecteur.

On insiste ainsi sur la linéarité de $L:h\mapsto f'(a) \cdot h$.
:::
\begin{equation*}
    L(h) = J_f(a) \cdot h,
\end{equation*}
