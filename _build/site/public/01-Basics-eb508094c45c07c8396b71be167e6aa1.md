...
Dans les cas qui nous intéressent, les espaces $E$ et $F$ sont $\mathbb{R}^n$ et $\mathbb{R^m}$ munis de leurs bases canoniques respectives, c'est-à-dire les vecteur $e_i$ tels que
\begin{equation*}
