...
\begin{equation*}
    \left( \begin{array}{c} accroissement \\ de la fonction \end{array} \right)
    =
    \left( \begin{array}{c} terme linéaire en l'accroissement \\ de la variable \end{array} \right)
    +
    \left( \begin{array}{c} petit terme \\ correctif \end{array} \right)
\end{equation*}
:::
