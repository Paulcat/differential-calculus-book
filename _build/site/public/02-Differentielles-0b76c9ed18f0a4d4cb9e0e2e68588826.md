...
Pour des fonctions $f : \mathbb{R} \to \mathbb{R}$, la notion de [différentiabilité](#def-diff) ci-dessus équivaut à celle de dérivabilité: en effet, l'existence de la limite
\begin{equation*}
