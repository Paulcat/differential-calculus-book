...
- pour les vecteurs de $\mathbb{R^n}$:
    - **la norme $1$**: pour tout $x \in \mathbb{R}^n$, $|\!| x |\!|_1 = \sum_{i=1}^n |x_i|$
    - **la norme $2$ (ou euclidienne)**: pour tout $x \in \mathbb{R}^n$, $|\!| x |\!|_2= \sqrt{\sum_{i=1}^n x_i^2}$
    - **la norme infini (ou norme sup)**: pour tout $x \in \mathbb{R}^n$, $|\!|x|\!|_\infty = \sup_{i} |x_i|$
