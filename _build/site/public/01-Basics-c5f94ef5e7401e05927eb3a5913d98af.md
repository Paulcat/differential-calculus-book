...
:::{note}
Dans les cas qui nous intéressent, les espaces $E$ et $F$ sont simplement $\mathbb{R}^n$ et $\mathbb{R^m}$ munis de leurs bases canoniques respectives, c'est-à-dire $e_i = \begin{bmatrix} 0 & \ldots & 1 & 0 & \ldots \end{bmatrix}^\top$. On notera alors plus simplement $M(f)$ la matrice d'une application linéaire.
:::
