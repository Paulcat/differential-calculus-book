...
Lorsque l'on peut trouver une base $(x_1,\ldots,x_n)$ de $\mathbb{R}^n$, telle que les vecteurs $x_i$ soient tous vecteurs propres de $M$, on dit que la matrice $M$ est diagonalisable: dans ce cas, on a
\begin{equation*}
    M = P \begin{pmatrix} \lambda_1 & & \\ & \ddots & \\ & & \lambda_n P^{-1}
\end{equation*}
