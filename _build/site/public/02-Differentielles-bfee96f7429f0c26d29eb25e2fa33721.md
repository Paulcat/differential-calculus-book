...
La définition précédente est valable pour des espaces $E$ et $F$ très généraux. Nous allons maintenant nous concentrer sur les exemples les plus standards, à savoir $E = \mathbb{R}^n$ et $F = \mathbb{R}^m$, en distinguant les cas où $n = 1$ et/ou $m=1$.
