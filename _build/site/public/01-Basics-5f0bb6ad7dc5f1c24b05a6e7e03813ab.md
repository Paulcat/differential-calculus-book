...
Le calcul différentiel repose sur la notion de comportement *local* des fonctions, ce qui suppose d'avoir défini une notion de distance. Pour cela, on munit nos espaces vectoriels de *normes*.
...
- $|\!| x |\!| = 0 \implies x = 0$
- $|\!| \lambda x |\!| = \abs{\lambda} |\!| x|\!|$ (homogénéité)
