...
Si l'application $f'$ est différentiable en $a$, on dit que $f$ est *deux fois différentiable en $a$* et on note $D^2f(a)$ la *différentielle seconde*. Les composantes $\partial_i f(x)$ admettent alors des dérivées partielles
:::
